    ...
    <div className="container-fluid">
      <div className="container">
        <div className="row">
          ...
          <p>
            Hello, and welcome to my page! I am a twenty-four years old, grew up
            in San Diego, CA and recently moved to Morrison, CO. My boyfriend
            and I live in a wonderful apartment with our dog, Osa, that
            overlooks Bear Creek. I originally moved to Colorado to partake in a
            coding program through Denver University, but given the pandemic,
            our courses are online anyways! As much as I miss San Diego,
            Colorado has become a place that I am proud to call home.
          </p>
          <p>
            ...
            running water. While we did have drinking water delivered bi-weekly,
            our main water supply was dependent on our well, which was dependent
            on rain. As water got low, we were allowed a half or quarter bucket
            a day to do any showering, washing, etc. As you can imagine, a warm
            shower and laundromat (or lavanderia) in the closet town, Tulum
            (about an hour North), was a true luxury on weekends we spent off
            base. It was a very grounding experience to say the least.
          </p>
          <p>
          ...
          <p>
            If you would like to learn more about the work I did in Mexico,
            please take a look at my{" "}
            <a href="assets/images/resume.pdf" target="_blank" rel="noreferrer">
              resume
            </a>
            .
          </p>
